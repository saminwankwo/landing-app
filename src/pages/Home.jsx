...
function Home() {
  ...
  useEffect(() => {
    setSeo({
      ...
      description: 'Samuel Nwankwo — Full-Stack Developer specializing in scalable web applications, APIs, business platforms, and complex systems. Book a free consultation.',
      path: '/',
        ...
        <div className="container">
          ...
          <div className="project-showcase fade-up" ref={el => fadeElementsRef.current.push(el)}>
            <div className="project-showcase__img-wrap">
              <video
                src="/familyTree.mp4"
                alt="Family Tree Platform video"
            ...
            <div className="project-breakdown">
              ...
              <div className="fade-up" style={{ marginTop: 'var(--sp-4)' }} ref={el => fadeElementsRef.current.push(el)}>
                <Link to="/case-studies/family-tree-platform" className="btn btn--ghost btn--full">Read Full Case Study →</Link>
              </div>
            </div>
          </div>
        </div>
